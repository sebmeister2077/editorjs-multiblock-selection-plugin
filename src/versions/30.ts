...
export type ConstructorProps = {
    ...
    /**
     * This is used internally for hiding the toolbar for versions 2.30 because toolbars dont have initially all its features rendered inside of it
...
export class MultiBlockSelectionPlugin_V2_30 {
    ...
    constructor({ editor, onBeforeToolbarOpen, toolbarHiddenTimeoutMs = 200 }: ConstructorProps) {
        ...
        this.observer = new MutationObserver((mutations) => {
            ...
            window.dispatchEvent(
                new CustomEvent(MultiBlockSelectionPlugin_V2_30.SELECTION_EVENT_NAME, {
    ...
    private verifyToolbarIsMountedWithItems() {
        ...
        const isEmpty = toolbar.childElementCount === 0;
        if (!isEmpty) return;
